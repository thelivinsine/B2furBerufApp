...
export interface RedemittelPhrase {
  ...
  // "diplomatic" was folded into "formal" (audit 2026-07-09): with 5 tagged
  // phrases it was a near-empty third tier, and diplomacy is a pragmatic
  // function, not a register. Revisit only with the parked Amtssprache axis.
