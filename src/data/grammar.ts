...
export const grammar: GrammarTopic[] = [
  /* ---------------- Konnektoren (expanded) ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_konnektoren_d6",
        prompt: "Der Antrag ist abgelehnt worden. ___ können Sie Widerspruch einlegen.",
        answer: "Allerdings",
        options: ["Allerdings", "Deshalb", "Indem", "Trotzdem"],
        explain: "'Allerdings' adds a restriction to what was just said. 'Deshalb' would claim a consequence.",
        gloss: "The application has been rejected. You can, however, file an objection.",
      },
      {
        id: "g_konnektoren_d7",
        prompt: "Die Wohnung ist klein, ___ liegt sie sehr zentral.",
        answer: "dafür",
        options: ["dafür", "deshalb", "sonst", "zudem"],
        explain: "'dafür' offers a compensating advantage: small, but central in return.",
        gloss: "The flat is small, but it is very central in return.",
      },
      {
        id: "g_konnektoren_d8",
        prompt: "Ergänze: Wir haben zu wenig Personal. ___ (deshalb / trotzdem) müssen wir die Öffnungszeiten kürzen.",
        answer: "Deshalb",
        explain: "A consequence follows from the reason, so 'deshalb'. Position 1, so the verb comes next.",
        gloss: "We have too little staff. That is why we have to shorten the opening hours.",
      },
      {
        id: "g_konnektoren_d9",
        prompt: "Ergänze: Der Bus fiel aus. Ich bin ___ (trotzdem / deswegen) pünktlich angekommen.",
        answer: "trotzdem",
        explain: "The result contradicts the reason, so it is a concession: 'trotzdem'.",
        gloss: "The bus was cancelled. I still arrived on time.",
      },
      {
        id: "g_konnektoren_d10",
        prompt: "Ergänze: Sie sparen Geld, ___ Sie den Vertrag online abschließen. (Mittel angeben)",
        answer: "indem",
        explain: "'indem' names the means by which something is achieved, and sends the verb to the end.",
        gloss: "You save money by taking out the contract online.",
      },
    ],
  },
  ...
  /* ---------------- Relativsätze ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_rel_d6",
        prompt: "Die Wohnung, ___ Fenster zum Hof zeigen, ist ruhiger.",
        answer: "deren",
        options: ["deren", "dessen", "der", "die"],
        explain: "Feminine (and plural) genitive relative pronoun is 'deren'.",
        gloss: "The flat whose windows face the courtyard is quieter.",
      },
      {
        id: "g_relativ_p4",
        prompt: "Verbinde mit einem Relativsatz: Das ist das Amt. Ich habe dort meinen Antrag gestellt.",
        answer: "Das ist das Amt, wo ich meinen Antrag gestellt habe.",
        explain: "A place can take 'wo' instead of a preposition plus relative pronoun.",
        gloss: "That is the office where I submitted my application.",
      },
    ],
  },
  ...
  /* ---------------- Präpositionalpronomen (da-/wo-words) ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_da_d6",
        prompt: "Wir haben lange auf den Bescheid gewartet. – Ja, wir haben lange ___ gewartet.",
        answer: "darauf",
        options: ["darauf", "davon", "dazu", "dafür"],
        explain: "'warten auf' keeps its preposition: auf → darauf.",
        gloss: "We waited a long time for the decision. Yes, we waited a long time for it.",
      },
      {
        id: "g_da_d7",
        prompt: "___ ärgerst du dich? – Über die lange Wartezeit.",
        answer: "Worüber",
        options: ["Worüber", "Wovon", "Wobei", "Wonach"],
        explain: "'sich ärgern über' asks with wo(r) + über. The answer's preposition tells you which wo-word to use.",
        gloss: "What are you annoyed about? About the long wait.",
      },
      {
        id: "g_da_d8",
        prompt: "Ergänze: Ich kümmere mich ___, dass die Unterlagen rechtzeitig ankommen.",
        answer: "darum",
        explain: "'sich kümmern um' → darum, and the da-word announces the dass-clause that follows.",
        gloss: "I will see to it that the documents arrive on time.",
      },
      {
        id: "g_da_d9",
        prompt: "Ergänze: Die Miete steigt. Wir müssen uns ___ einstellen. (sich einstellen auf)",
        answer: "darauf",
        explain: "'sich einstellen auf' → darauf. The 'r' appears because the preposition starts with a vowel.",
        gloss: "The rent is going up. We have to prepare for it.",
      },
      {
        id: "g_da_d10",
        prompt: "Ergänze: ___ besteht der Unterschied? – In der Laufzeit. (Frage nach 'bestehen in')",
        answer: "Worin",
        explain: "'bestehen in' asks with worin. Answering 'in …' confirms the preposition.",
        gloss: "What does the difference consist in? In the term.",
      },
    ],
  },
  ...
  /* ---------------- Verbstellung / Verbklammer (TeKaMoLo) ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_verb_d6",
        prompt: "Was steht auf Position 1? „___ habe ich den Antrag abgeschickt.“ (Zeitangabe)",
        answer: "Gestern",
        options: ["Gestern", "Habe", "Den Antrag", "Abgeschickt"],
        explain: "Any single element may take position 1; the conjugated verb still comes second.",
        gloss: "Yesterday I sent off the application.",
      },
      {
        id: "g_verb_d7",
        prompt: "Im Nebensatz steht das konjugierte Verb ___.",
        answer: "am Ende",
        options: ["am Ende", "an Position 2", "an Position 1", "vor dem Subjekt"],
        explain: "A subordinate clause moves the conjugated verb to the end.",
        gloss: "In a subordinate clause the conjugated verb goes at the end.",
      },
      {
        id: "g_verb_d8",
        prompt: "Ordne: den Termin / ich / leider / absagen / muss",
        answer: "Ich muss den Termin leider absagen.",
        explain: "Modal in second position, infinitive at the end: that is the Verbklammer.",
        gloss: "Unfortunately I have to cancel the appointment.",
      },
      {
        id: "g_verb_d9",
        prompt: "Ordne: nächste Woche / die Wohnung / wir / besichtigen / können",
        answer: "Wir können nächste Woche die Wohnung besichtigen.",
        explain: "Te-Ka-Mo-Lo: the time phrase comes before the object here because the object is definite.",
        gloss: "We can view the flat next week.",
      },
      {
        id: "g_verb_d10",
        prompt: "Beginne mit 'Morgen': Ich bringe die Unterlagen zum Amt.",
        answer: "Morgen bringe ich die Unterlagen zum Amt.",
        explain: "Fronting a time phrase pushes the subject behind the verb, which stays second.",
        gloss: "Tomorrow I am taking the documents to the office.",
      },
    ],
  },
  ...
  /* ---------------- Nebensätze: dass / weil / damit ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_neb_d6",
        prompt: "Ich rufe an, ___ ich eine Frage zur Rechnung habe.",
        answer: "weil",
        options: ["weil", "dass", "damit", "ob"],
        explain: "'weil' gives the reason and sends the verb to the end.",
        gloss: "I am calling because I have a question about the invoice.",
      },
      {
        id: "g_nebensatz_p4",
        prompt: "Verbinde mit 'dass': Es tut mir leid. Ich habe den Termin vergessen.",
        answer: "Es tut mir leid, dass ich den Termin vergessen habe.",
        explain: "The dass-clause keeps the conjugated verb in final position.",
        gloss: "I am sorry that I forgot the appointment.",
      },
    ],
  },
  ...
  /* ---------------- Kasus & Wechselpräpositionen ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_kasus_d6",
        prompt: "Ich warte seit einer Stunde vor ___ Praxis. (wo?)",
        answer: "der",
        options: ["der", "die", "den", "dem"],
        explain: "'vor' with a static position takes the dative; feminine dative is 'der'.",
        gloss: "I have been waiting outside the practice for an hour.",
      },
      {
        id: "g_kasus_p4",
        prompt: "Ergänze den Artikel: Bitte hängen Sie den Mantel an ___ Haken. (Wohin?)",
        answer: "den",
        explain: "Direction takes the accusative: an den Haken.",
        gloss: "Please hang your coat on the hook.",
      },
    ],
  },
  ...
  /* ---------------- Nomen-Verb-Verbindungen (explainer) ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_nv_d6",
        prompt: "Die Behörde ___ den Antrag in Bearbeitung.",
        answer: "nimmt",
        options: ["nimmt", "macht", "setzt", "gibt"],
        explain: "'in Bearbeitung nehmen' is fixed: the verb is nehmen.",
        gloss: "The authority is taking the application into processing.",
      },
      {
        id: "g_nv_d7",
        prompt: "Darf ich eine Frage ___?",
        answer: "stellen",
        options: ["stellen", "machen", "fragen", "geben"],
        explain: "'eine Frage stellen' is the fixed combination; 'eine Frage machen' does not exist.",
        gloss: "May I ask a question?",
      },
      {
        id: "g_nv_d8",
        prompt: "Ergänze: Wir ___ Ihre Reklamation in Betracht. (in Betracht ziehen)",
        answer: "ziehen",
        explain: "'in Betracht ziehen' takes ziehen.",
        gloss: "We are taking your complaint into consideration.",
      },
      {
        id: "g_nv_d9",
        prompt: "Ergänze: Der Mieter ___ Anspruch auf eine Mietminderung. (Anspruch haben)",
        answer: "hat",
        explain: "'Anspruch auf etwas haben' is the fixed form for a legal entitlement.",
        gloss: "The tenant is entitled to a rent reduction.",
      },
      {
        id: "g_nv_d10",
        prompt: "Ergänze: Bitte ___ Sie mir Bescheid, sobald der Termin steht.",
        answer: "geben",
        explain: "'Bescheid geben' is fixed; 'Bescheid sagen' is the spoken variant.",
        gloss: "Please let me know as soon as the appointment is fixed.",
      },
    ],
  },
  ...
  /* ---------------- Konjunktiv II ---------------- */
  {
    ...
    drills: [
      ...
      },
      {
        ...
        answer: "Würden",
        options: ["Würden", "Wurden", "Werden", "Wären"],
        explain: "'Würden Sie …?' is the standard polite request. 'Wurden' is the past passive form.",
        gloss: "Could you help me briefly, please?",
      },
      {
        id: "g_k2_d6",
        prompt: "An Ihrer Stelle ___ ich sofort Widerspruch einlegen.",
        answer: "würde",
        options: ["würde", "werde", "wäre", "hätte"],
        explain: "Advice in an imagined situation takes würde + Infinitiv.",
        gloss: "In your position I would file an objection immediately.",
      },
      {
        id: "g_k2_d7",
        prompt: "Wenn wir mehr Zeit ___, würden wir alles noch einmal prüfen.",
        answer: "hätten",
        options: ["hätten", "haben", "hatten", "wären"],
        explain: "The wenn-clause of an unreal condition takes Konjunktiv II: hätten, not the past hatten.",
        gloss: "If we had more time we would check everything again.",
      },
      {
        id: "g_k2_d8",
        prompt: "Ergänze: Höflicher: „Ich will einen Termin.“ → „Ich ___ gern einen Termin.“",
        answer: "hätte",
        explain: "'Ich hätte gern' is the polite everyday request form at the counter.",
        gloss: "I would like an appointment.",
      },
      {
        id: "g_k2_d9",
        prompt: "Ergänze: Vorsichtiger Rat: „Du ___ (sollen) mit deinem Vermieter sprechen.“",
        answer: "solltest",
        explain: "Konjunktiv II of sollen softens advice from an order into a suggestion.",
        gloss: "You should talk to your landlord.",
      },
      {
        id: "g_k2_d10",
        prompt: "Ergänze: Vermutung: „Das ___ (können) an der neuen Software liegen.“",
        answer: "könnte",
        explain: "Konjunktiv II of können states a possibility rather than an ability.",
        gloss: "That could be down to the new software.",
      },
    ],
  },
  ...
  /* ---------------- Modalverben ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_mod_d5",
        prompt: "___ ich Ihnen noch etwas bringen? (höfliches Angebot)",
        answer: "Darf",
        options: ["Darf", "Muss", "Will", "Soll"],
        explain: "'dürfen' offers politely; 'wollen' would state your own wish.",
        gloss: "May I bring you anything else?",
      },
      {
        id: "g_modal_p4",
        prompt: "Ergänze das Modalverb: Wir ___ noch ein Formular ausfüllen, sonst gilt der Antrag nicht.",
        answer: "müssen",
        explain: "A necessity with a consequence takes müssen.",
        gloss: "We have to fill in one more form, otherwise the application is not valid.",
      },
      {
        id: "g_modal_p5",
        prompt: "Schreibe mit 'können': Es ist mir nicht möglich, heute zu kommen.",
        answer: "Ich kann heute nicht kommen.",
        explain: "können states ability or possibility; the infinitive closes the sentence.",
        gloss: "I cannot come today.",
      },
    ],
  },
  ...
  /* ---------------- Passiv ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_pas_d5",
        prompt: "Ihr Antrag ___ bereits bearbeitet worden.",
        answer: "ist",
        options: ["ist", "hat", "wird", "wurde"],
        explain: "The Perfekt passive is sein + Partizip II + worden, so 'ist … bearbeitet worden'.",
        gloss: "Your application has already been processed.",
      },
      {
        id: "g_pas_d6",
        prompt: "Die Rechnung wird ___ der Buchhaltung geprüft.",
        answer: "von",
        options: ["von", "durch", "mit", "bei"],
        explain: "The agent (who acts) takes 'von'; 'durch' names the means, not the person.",
        gloss: "The invoice is being checked by accounting.",
      },
      {
        id: "g_pas_d7",
        prompt: "In diesem Bereich ___ Schutzbrille getragen werden.",
        answer: "muss",
        options: ["muss", "wird", "ist", "hat"],
        explain: "A modal passive puts the modal in second position: muss … getragen werden.",
        gloss: "Safety goggles must be worn in this area.",
      },
      {
        id: "g_pas_d8",
        prompt: "Ergänze: Aktiv → Passiv: „Der Techniker repariert die Anlage.“ → „Die Anlage ___ repariert.“",
        answer: "wird",
        explain: "The accusative object becomes the subject and the verb becomes werden + Partizip II.",
        gloss: "The technician repairs the machine. → The machine is repaired.",
      },
      {
        id: "g_pas_d9",
        prompt: "Ergänze: Aktiv → Passiv (Präteritum): „Man informierte die Mieter.“ → „Die Mieter ___ informiert.“",
        answer: "wurden",
        explain: "Plural subject in the Präteritum passive takes wurden.",
        gloss: "The tenants were informed.",
      },
      {
        id: "g_pas_d10",
        prompt: "Ergänze: Unpersönlich: „Hier ___ nicht geraucht.“ (Passiv ohne Subjekt)",
        answer: "wird",
        explain: "A subjectless passive still takes wird: the rule matters, not who follows it.",
        gloss: "There is no smoking here.",
      },
    ],
  },
  ...
  /* ---------------- Indirekte Rede (Konjunktiv I) ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_indirekte_rede_d6",
        prompt: "Sie sagt, sie ___ den Brief noch nicht erhalten.",
        answer: "habe",
        options: ["habe", "hat", "hätte", "haben"],
        explain: "Third person singular Konjunktiv I of haben is habe, and it differs from the indicative 'hat'.",
        gloss: "She says she has not yet received the letter.",
      },
      {
        id: "g_indirekte_rede_d7",
        prompt: "Der Arzt sagte, ich ___ mich schonen.",
        answer: "solle",
        options: ["solle", "soll", "sollte", "sollen"],
        explain: "Konjunktiv I of sollen is solle; the indicative 'soll' would quote directly.",
        gloss: "The doctor said I should take it easy.",
      },
      {
        id: "g_indirekte_rede_d8",
        prompt: "Ergänze: „Ich komme später.“ → Er sagt, er ___ später.",
        answer: "komme",
        explain: "Konjunktiv I is formed from the infinitive stem plus -e.",
        gloss: "He says he is coming later.",
      },
      {
        id: "g_indirekte_rede_d9",
        prompt: "Ergänze: „Wir haben nichts bekommen.“ → Sie sagen, sie ___ nichts bekommen.",
        answer: "hätten",
        explain: "Plural Konjunktiv I ('haben') looks like the indicative, so Konjunktiv II 'hätten' takes over.",
        gloss: "They say they received nothing.",
      },
      {
        id: "g_indirekte_rede_d10",
        prompt: "Ergänze: „Der Antrag wurde abgelehnt.“ → Im Bericht steht, der Antrag ___ abgelehnt worden.",
        answer: "sei",
        explain: "The passive in reported speech uses Konjunktiv I of sein: sei … worden.",
        gloss: "The report says the application was rejected.",
      },
    ],
  },
  ...
  /* ---------------- Zweiteilige Konnektoren ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_zweiteilige_konnektoren_d6",
        prompt: "Sie können ___ überweisen oder bar bezahlen.",
        answer: "entweder",
        options: ["entweder", "sowohl", "weder", "nicht nur"],
        explain: "'entweder … oder' offers two alternatives, exactly one of which applies.",
        gloss: "You can either transfer the money or pay cash.",
      },
      {
        id: "g_zweiteilige_konnektoren_d7",
        prompt: "Der Kurs ist ___ nur günstig, sondern auch abends.",
        answer: "nicht",
        options: ["nicht", "weder", "sowohl", "entweder"],
        explain: "The pair is 'nicht nur …, sondern auch …'.",
        gloss: "The course is not only cheap but also in the evening.",
      },
      {
        id: "g_zweiteilige_konnektoren_d8",
        prompt: "Ergänze: Zwei Vorteile nennen: „Die Wohnung ist ___ hell als auch ruhig.“",
        answer: "sowohl",
        explain: "'sowohl … als auch' adds two qualities that both apply.",
        gloss: "The flat is both bright and quiet.",
      },
      {
        id: "g_zweiteilige_konnektoren_d9",
        prompt: "Ergänze: Beides verneinen: „Ich habe ___ eine Bestätigung noch eine Rechnung bekommen.“",
        answer: "weder",
        explain: "'weder … noch' negates both parts, so no extra 'nicht' is needed.",
        gloss: "I received neither a confirmation nor an invoice.",
      },
      {
        id: "g_zweiteilige_konnektoren_d10",
        prompt: "Ergänze: Je früher Sie den Antrag stellen, ___ schneller bekommen Sie den Termin.",
        answer: "desto",
        explain: "'je + Komparativ …, desto + Komparativ' links two rising quantities.",
        gloss: "The earlier you apply, the sooner you get an appointment.",
      },
    ],
  },
  ...
  /* ---------------- Infinitivsätze ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_infinitivsaetze_d6",
        prompt: "Vergessen Sie bitte nicht, das Formular ___.",
        answer: "zu unterschreiben",
        options: ["zu unterschreiben", "unterschreiben", "zu unterschreiben zu", "unterschreiben zu"],
        explain: "A plain zu-clause puts 'zu' directly before the infinitive at the end.",
        gloss: "Please do not forget to sign the form.",
      },
      {
        id: "g_infinitivsaetze_d7",
        prompt: "Ich rufe an, ___ einen Termin zu vereinbaren.",
        answer: "um",
        options: ["um", "ohne", "statt", "damit"],
        explain: "'um … zu' states the purpose when both clauses share a subject.",
        gloss: "I am calling in order to arrange an appointment.",
      },
      {
        id: "g_infinitivsaetze_d8",
        prompt: "Ergänze: Trennbares Verb: „Ich habe versprochen, Sie morgen ___. (anrufen)“",
        answer: "anzurufen",
        explain: "With a separable verb the 'zu' goes inside: an + zu + rufen.",
        gloss: "I promised to call you tomorrow.",
      },
      {
        id: "g_infinitivsaetze_d9",
        prompt: "Ergänze: „Er ist gegangen, ___ sich zu verabschieden.“ (= und hat sich nicht verabschiedet)",
        answer: "ohne",
        explain: "'ohne … zu' says the expected action did not happen.",
        gloss: "He left without saying goodbye.",
      },
      {
        id: "g_infinitivsaetze_d10",
        prompt: "Ergänze: Zwei Subjekte, also kein 'um … zu': „Ich schicke den Plan, ___ Sie ihn prüfen können.“",
        answer: "damit",
        explain: "When the two clauses have different subjects, use damit, not um … zu.",
        gloss: "I am sending the plan so that you can check it.",
      },
    ],
  },
  ...
  /* ---------------- Finalsätze ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_finalsaetze_d6",
        prompt: "Ich nehme mir einen Dolmetscher mit, ___ ich beim Amt alles verstehe.",
        answer: "damit",
        options: ["damit", "um", "weil", "ohne"],
        explain: "Two different subjects (ich / ich verstehe … with a new clause) still take damit when the purpose has its own finite verb.",
        gloss: "I am bringing an interpreter so that I understand everything at the office.",
      },
      {
        id: "g_final_p4",
        prompt: "Verbinde mit 'um … zu': Ich gehe zur Bank. Ich will ein Konto eröffnen.",
        answer: "Ich gehe zur Bank, um ein Konto zu eröffnen.",
        explain: "Same subject in both clauses, so um … zu is the shorter and better form.",
        gloss: "I am going to the bank to open an account.",
      },
    ],
  },
  ...
  /* ---------------- Temporalsätze ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_temporalsaetze_d6",
        prompt: "Nachdem ich angerufen ___, war der Termin sofort frei.",
        answer: "hatte",
        options: ["hatte", "habe", "bin", "war"],
        explain: "'nachdem' with a past main clause takes the Plusquamperfekt: hatte … angerufen.",
        gloss: "After I had called, the appointment was immediately available.",
      },
      {
        id: "g_temporal_p4",
        prompt: "Verbinde mit 'sobald': Der Bescheid kommt. Ich melde mich bei Ihnen.",
        answer: "Sobald der Bescheid kommt, melde ich mich bei Ihnen.",
        explain: "The sobald-clause comes first, so the main clause starts with its verb.",
        gloss: "As soon as the decision arrives I will get in touch.",
      },
    ],
  },
  /* ---------------- Vergleichssätze ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_vergleichssaetze_d6",
        prompt: "Die Wartezeit war kürzer, ___ ich befürchtet hatte.",
        answer: "als",
        options: ["als", "wie", "als ob", "so wie"],
        explain: "After a comparative the comparison word is 'als'.",
        gloss: "The wait was shorter than I had feared.",
      },
      {
        id: "g_vergleichssaetze_d7",
        prompt: "Der Kollege redet, ___ er alles besser wüsste.",
        answer: "als ob",
        options: ["als ob", "als wie", "wie ob", "so als"],
        explain: "'als ob' + Konjunktiv II marks something as merely apparent.",
        gloss: "The colleague talks as if he knew everything better.",
      },
      {
        id: "g_vergleichssaetze_d8",
        prompt: "Ergänze: Gleichheit: „Die Reparatur kostet genauso viel ___ ein neues Gerät.“",
        answer: "wie",
        explain: "Equality takes so/genauso … wie; only inequality takes 'als'.",
        gloss: "The repair costs just as much as a new device.",
      },
      {
        id: "g_vergleichssaetze_d9",
        prompt: "Ergänze: „Sie sieht aus, als ___ sie krank. (sein, Konjunktiv II)“",
        answer: "wäre",
        explain: "After 'als ob' or 'als' the verb goes into Konjunktiv II: wäre.",
        gloss: "She looks as if she were ill.",
      },
      {
        id: "g_vergleichssaetze_d10",
        prompt: "Ergänze: Ohne 'ob' steht das Verb direkt nach 'als': „Es klingt, ___ das Angebot noch gilt. (klingen)“",
        answer: "als gelte",
        explain: "Without 'ob' the conjugated verb follows 'als' immediately, in Konjunktiv.",
        gloss: "It sounds as though the offer still applies.",
      },
    ],
  },
  ...
  /* ---------------- Partizipialattribute ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_partizipialattribute_d6",
        prompt: "Der ___ Betrag wird zurückerstattet. (zu viel zahlen → Partizip II)",
        answer: "zu viel gezahlte",
        options: ["zu viel gezahlte", "zu viel zahlende", "zu viel gezahlt", "zu viel zahlend"],
        explain: "Partizip II is passive and finished: the amount was paid, so 'gezahlte'.",
        gloss: "The amount paid in excess will be refunded.",
      },
      {
        id: "g_partizipialattribute_d7",
        prompt: "Die ___ Kosten müssen noch genehmigt werden. (entstehen → Partizip I)",
        answer: "entstehenden",
        options: ["entstehenden", "entstandenen", "entstehende", "entstanden"],
        explain: "Partizip I is active and ongoing; after 'die' in the plural the ending is -en.",
        gloss: "The costs arising still have to be approved.",
      },
      {
        id: "g_partizipialattribute_d8",
        prompt: "Ergänze: Auflösen: „das unterschriebene Formular“ = das Formular, das unterschrieben ___ ist.",
        answer: "worden",
        explain: "Partizip II as an attribute unfolds into a passive relative clause.",
        gloss: "the signed form = the form that has been signed",
      },
      {
        id: "g_partizipialattribute_d9",
        prompt: "Ergänze: „die wartenden Patienten“ = die Patienten, die ___",
        answer: "warten",
        explain: "Partizip I unfolds into an active relative clause in the present.",
        gloss: "the waiting patients = the patients who are waiting",
      },
      {
        id: "g_partizipialattribute_d10",
        prompt: "Ergänze: Erweitert: „die am Montag ___ Lieferung“ (eintreffen, Partizip I)",
        answer: "eintreffende",
        explain: "In an extended attribute the modifiers sit between the article and the participle.",
        gloss: "the delivery arriving on Monday",
      },
    ],
  },
  ...
  /* ---------------- Genitiv & Präpositionen mit Genitiv ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_genitiv_d6",
        prompt: "Innerhalb ___ Woche bekommen Sie den Bescheid.",
        answer: "einer",
        options: ["einer", "eine", "einem", "einen"],
        explain: "'innerhalb' takes the genitive; feminine singular is 'einer'.",
        gloss: "You will receive the decision within a week.",
      },
      {
        id: "g_genitiv_d7",
        prompt: "Anstelle ___ Termins schlage ich ein Telefonat vor.",
        answer: "des",
        options: ["des", "der", "dem", "den"],
        explain: "'anstelle' + genitive; masculine singular takes des + -s on the noun.",
        gloss: "Instead of an appointment I suggest a phone call.",
      },
      {
        id: "g_genitiv_d8",
        prompt: "Ergänze: Der Name ___ Vermieterin steht im Vertrag. (die Vermieterin)",
        answer: "der",
        explain: "Feminine genitive is 'der', and the noun itself does not change.",
        gloss: "The landlady's name is in the contract.",
      },
      {
        id: "g_genitiv_d9",
        prompt: "Ergänze: Gesprochen sagt man 'wegen dem Streik', geschrieben korrekt: „wegen ___ Streiks“.",
        answer: "des",
        explain: "In writing 'wegen' takes the genitive, even though the dative is common in speech.",
        gloss: "because of the strike",
      },
      {
        id: "g_genitiv_d10",
        prompt: "Ergänze: Während ___ Bauarbeiten bleibt der Hintereingang offen. (die Bauarbeiten, Plural)",
        answer: "der",
        explain: "Genitive plural is 'der' for every gender.",
        gloss: "During the building work the back entrance stays open.",
      },
    ],
  },
  ...
  /* ---------------- n-Deklination ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_ndeklination_d7",
        prompt: "Ich habe den ___ noch nicht erreicht. (der Nachbar)",
        answer: "Nachbarn",
        options: ["Nachbarn", "Nachbar", "Nachbars", "Nachbare"],
        explain: "'der Nachbar' is a weak noun: every case except the nominative singular adds -n.",
        gloss: "I have not reached the neighbour yet.",
      },
      {
        id: "g_ndeklination_d8",
        prompt: "Der Antrag muss vom ___ unterschrieben werden. (der Patient)",
        answer: "Patienten",
        options: ["Patienten", "Patient", "Patients", "Patiente"],
        explain: "Weak nouns in -ent take -en in the dative too.",
        gloss: "The application must be signed by the patient.",
      },
      {
        id: "g_ndeklination_d9",
        prompt: "Ergänze: Wir bieten dem ___ eine Ersatzlieferung an. (der Kunde)",
        answer: "Kunden",
        explain: "Dative singular of a weak noun: Kunde → Kunden.",
        gloss: "We are offering the customer a replacement delivery.",
      },
      {
        id: "g_ndeklination_d10",
        prompt: "Ergänze: Ausnahme mit -ns im Genitiv: „die Meinung des ___“ (der Name)",
        answer: "Namens",
        explain: "'Name' is a mixed noun: -n in the other cases but -ns in the genitive.",
        gloss: "the meaning of the name",
      },
      {
        id: "g_ndeklination_d6",
        prompt: "Ergänze: Ohne Artikel bleibt die Endung: „Als ___ muss man flexibel sein.“ (der Praktikant)",
        answer: "Praktikant",
        explain: "In the nominative the weak noun has no ending, even after 'als'.",
        gloss: "As an intern you have to be flexible.",
      },
    ],
  },
  ...
  /* ---------------- Nominalisierung ↔ Verbalstil ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_nominalisierung_d6",
        prompt: "„Weil das Wetter schlecht war“ im Nominalstil: „___ des schlechten Wetters“.",
        answer: "Wegen",
        options: ["Wegen", "Trotz", "Während", "Statt"],
        explain: "A causal weil-clause becomes wegen + genitive.",
        gloss: "because of the bad weather",
      },
      {
        id: "g_nominalisierung_d7",
        prompt: "„Bevor Sie unterschreiben“ heißt kurz: „___ der Unterschrift“.",
        answer: "Vor",
        options: ["Vor", "Nach", "Bei", "Seit"],
        explain: "bevor → vor + dative noun.",
        gloss: "before signing",
      },
      {
        id: "g_nominalisierung_d8",
        prompt: "Ergänze: Das Nomen zu 'einreichen' ist die ___.",
        answer: "Einreichung",
        explain: "Verbs in -en form a noun in -ung for the process.",
        gloss: "the submission",
      },
      {
        id: "g_nominalisierung_d9",
        prompt: "Ergänze: „Obwohl es geregnet hat“ im Nominalstil: „___ des Regens“.",
        answer: "Trotz",
        explain: "A concessive obwohl-clause becomes trotz + genitive.",
        gloss: "despite the rain",
      },
      {
        id: "g_nominalisierung_d10",
        prompt: "Ergänze: Zurück zum Verbalstil: „Nach Prüfung der Unterlagen“ = Nachdem wir die Unterlagen ___ haben.",
        answer: "geprüft",
        explain: "The noun goes back to its verb; the tense comes from the main clause.",
        gloss: "after checking the documents = after we have checked the documents",
      },
    ],
  },
  /* ---------------- lassen + Infinitiv ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_lassen_d6",
        prompt: "Wir ___ die Heizung vom Hausmeister prüfen.",
        answer: "lassen",
        options: ["lassen", "lässt", "ließen", "gelassen"],
        explain: "'wir' takes lassen; the second infinitive stays at the end.",
        gloss: "We are having the heating checked by the caretaker.",
      },
      {
        id: "g_lassen_d7",
        prompt: "Der Termin ___ sich leider nicht verschieben.",
        answer: "lässt",
        options: ["lässt", "lasst", "ließ", "lassen"],
        explain: "'sich lassen' + Infinitiv means 'can be done'; third person singular is lässt.",
        gloss: "The appointment unfortunately cannot be moved.",
      },
      {
        id: "g_lassen_d8",
        prompt: "Ergänze: Perfekt: „Ich habe mir die Haare schneiden ___.“",
        answer: "lassen",
        explain: "In the Perfekt with a second infinitive, lassen keeps its infinitive form (Ersatzinfinitiv).",
        gloss: "I had my hair cut.",
      },
      {
        id: "g_lassen_d9",
        prompt: "Ergänze: Erlaubnis: „Meine Chefin ___ mich von zu Hause arbeiten.“",
        answer: "lässt",
        explain: "'lassen' also grants permission, not only an order to a third party.",
        gloss: "My boss lets me work from home.",
      },
      {
        id: "g_lassen_d10",
        prompt: "Ergänze: „Der Schaden lässt sich beheben.“ bedeutet: Der Schaden ___ behoben werden.",
        answer: "kann",
        explain: "'sich lassen' + Infinitiv is a passive replacement for können + Passiv.",
        gloss: "The damage can be repaired.",
      },
    ],
  },
  ...
  /* ---------------- brauchen + zu ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_brauchen_zu_d6",
        prompt: "Sie ___ keinen Termin zu vereinbaren, kommen Sie einfach vorbei.",
        answer: "brauchen",
        options: ["brauchen", "müssen", "dürfen", "sollen"],
        explain: "With 'kein' the construction is brauchen … zu, not müssen.",
        gloss: "You do not need to make an appointment, just come by.",
      },
      {
        id: "g_brauchen_zu_d7",
        prompt: "Du brauchst nur kurz ___ unterschreiben.",
        answer: "zu",
        options: ["zu", "um", "für", "-"],
        explain: "'brauchen' takes 'zu' before the infinitive in the written standard.",
        gloss: "You only need to sign briefly.",
      },
      {
        id: "g_brauchen_zu_d8",
        prompt: "Ergänze: „Sie müssen nichts mitbringen.“ mit brauchen: „Sie ___ nichts mitzubringen.“",
        answer: "brauchen",
        explain: "Negated müssen becomes brauchen … zu; the separable verb takes zu inside.",
        gloss: "You do not need to bring anything.",
      },
      {
        id: "g_brauchen_zu_d9",
        prompt: "Ergänze: „Das Einzige: anrufen.“ → „Sie brauchen ___ anzurufen.“",
        answer: "nur",
        explain: "'nur brauchen zu' marks the one thing that is required.",
        gloss: "You only need to call.",
      },
      {
        id: "g_brauchen_zu_d10",
        prompt: "Ergänze: „Sie brauchen nicht zu zahlen.“ bedeutet: Sie ___ nicht zahlen.",
        answer: "müssen",
        explain: "'nicht brauchen zu' equals 'nicht müssen', never 'nicht dürfen'.",
        gloss: "You do not have to pay.",
      },
    ],
  },
  ...
  /* ---------------- Futur I/II für Vermutungen ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_futur_vermutung_d6",
        prompt: "Das Paket ist nicht da. Es ___ wohl noch unterwegs sein.",
        answer: "wird",
        options: ["wird", "würde", "werde", "wurde"],
        explain: "Futur I plus 'wohl' expresses an assumption about the present.",
        gloss: "The parcel is not here. It is probably still on its way.",
      },
      {
        id: "g_futur_vermutung_d7",
        prompt: "Sie meldet sich nicht. Sie wird den Termin vergessen ___.",
        answer: "haben",
        options: ["haben", "sein", "werden", "worden"],
        explain: "Futur II uses haben or sein by the verb's own Perfekt: vergessen takes haben.",
        gloss: "She is not getting in touch. She will have forgotten the appointment.",
      },
      {
        id: "g_futur_vermutung_d8",
        prompt: "Ergänze: Vermutung über jetzt: „Er ist nicht am Platz. Er ___ in der Pause sein.“",
        answer: "wird",
        explain: "Futur I for a present assumption: wird + Infinitiv.",
        gloss: "He is not at his desk. He is probably on a break.",
      },
      {
        id: "g_futur_vermutung_d9",
        prompt: "Ergänze: Vermutung über früher: „Die Bahn ___ wohl Verspätung gehabt haben.“",
        answer: "wird",
        explain: "Futur II keeps 'wird' and moves the assumption into the past via the Perfekt infinitive.",
        gloss: "The train will probably have been delayed.",
      },
      {
        id: "g_futur_vermutung_d10",
        prompt: "Ergänze: Sicherer machen: „Das wird ___ stimmen.“ (Partikel für beruhigende Sicherheit)",
        answer: "schon",
        explain: "The particle 'schon' turns the guess into calm reassurance.",
        gloss: "That will be right, I am sure.",
      },
    ],
  },
  ...
  /* ---------------- es-Konstruktionen ---------------- */
  {
    ...
    drills: [
      ...
      {
        id: "g_es_konstruktionen_d6",
        prompt: "___ ist wichtig, den Termin einzuhalten.",
        answer: "Es",
        options: ["Es", "Das", "Man", "Dies"],
        explain: "'es' holds the subject position for the infinitive clause that follows.",
        gloss: "It is important to keep the appointment.",
      },
      {
        id: "g_es_konstruktionen_d7",
        prompt: "Bei Fragen wenden Sie sich an uns. ___ lohnt sich, früh anzurufen.",
        answer: "Es",
        options: ["Es", "Man", "Das", "Sich"],
        explain: "'sich lohnen' takes the dummy subject 'es'.",
        gloss: "It is worth calling early.",
      },
      {
        id: "g_es_konstruktionen_d8",
        prompt: "Ergänze: Wetter und Befinden: „___ ist mir zu warm im Büro.“",
        answer: "Es",
        explain: "Weather and physical states take an obligatory 'es' subject.",
        gloss: "It is too warm for me in the office.",
      },
      {
        id: "g_es_konstruktionen_d9",
        prompt: "Ergänze: Ohne Platzhalter: „Es fehlen noch zwei Unterschriften.“ → „Zwei Unterschriften ___ noch.“",
        answer: "fehlen",
        explain: "When the real subject moves to position 1, the placeholder 'es' disappears.",
        gloss: "Two signatures are still missing.",
      },
      {
        id: "g_es_konstruktionen_d10",
        prompt: "Ergänze: Fester Ausdruck: „In dem Schreiben ___ es sich um eine Mahnung.“ (sich handeln um)",
        answer: "handelt",
        explain: "'es handelt sich um' keeps its 'es' in every position.",
        gloss: "The letter is a payment reminder.",
      },
    ],
  },
     ...
     particles that carry tone. */
  {
    ...
    drills: [
      ...
      {
        id: "g_konzessiv_d6",
        prompt: "___ der hohen Kosten halten wir am Plan fest.",
        answer: "Ungeachtet",
        options: ["Ungeachtet", "Wegen", "Anhand", "Mangels"],
        explain: "'ungeachtet' + genitive concedes the cost without letting it decide.",
        gloss: "Regardless of the high costs we are sticking to the plan.",
      },
      {
        id: "g_konzessiv_d7",
        prompt: "Wir liefern am Freitag, ___ Sie heute bestellen.",
        answer: "vorausgesetzt",
        options: ["vorausgesetzt", "obwohl", "wenngleich", "geschweige"],
        explain: "'vorausgesetzt' names the condition the promise depends on.",
        gloss: "We will deliver on Friday provided you order today.",
      },
      {
        id: "g_konzessiv_d8",
        prompt: "Ergänze: Einräumen und einschränken: „Der Preis ist ___ hoch, doch die Qualität stimmt.“",
        answer: "zwar",
        explain: "'zwar …, doch/aber …' concedes a point before restricting it.",
        gloss: "The price is high, admittedly, but the quality is right.",
      },
      {
        id: "g_konzessiv_d9",
        prompt: "Ergänze: Nebensatz mit Endstellung: „___ die Frist abgelaufen ist, prüfen wir Ihren Fall.“",
        answer: "Obwohl",
        explain: "'obwohl' introduces a subordinate clause, so the verb goes last.",
        gloss: "Although the deadline has passed, we will look at your case.",
      },
      {
        id: "g_konzessiv_d10",
        prompt: "Ergänze: Einzige Ausnahme nennen: „Wir sind erreichbar, ___, es ist Feiertag.“",
        answer: "es sei denn",
        explain: "'es sei denn' names the one case that cancels the statement.",
        gloss: "We are available unless it is a public holiday.",
      },
    ],
  },
  {
    ...
    drills: [
      ...
      {
        id: "g_passiversatz_d6",
        prompt: "„Der Antrag kann online gestellt werden.“ → „Der Antrag ist online ___.",
        answer: "zu stellen",
        options: ["zu stellen", "stellend", "gestellt", "zu stellend"],
        explain: "'sein + zu + Infinitiv' replaces a können- or müssen-passive.",
        gloss: "The application can be submitted online.",
      },
      {
        id: "g_passiversatz_d7",
        prompt: "„Man kann die Schrift gut lesen.“ → „Die Schrift ist gut ___.",
        answer: "lesbar",
        options: ["lesbar", "leslich", "gelesen", "lesend"],
        explain: "The suffix -bar turns the verb into a passive possibility adjective.",
        gloss: "The writing is easy to read.",
      },
      {
        id: "g_passiversatz_d8",
        prompt: "Ergänze: „Die Tür kann nicht geöffnet werden.“ → „Die Tür ___ nicht öffnen. (sich lassen)“",
        answer: "lässt sich",
        explain: "'sich lassen' + Infinitiv is the most common spoken passive replacement.",
        gloss: "The door cannot be opened.",
      },
      {
        id: "g_passiversatz_d9",
        prompt: "Ergänze: „Hier muss leise gesprochen werden.“ → „Hier ___ leise sprechen. (man)“",
        answer: "muss man",
        explain: "'man' + active keeps the rule impersonal without a passive.",
        gloss: "One has to speak quietly here.",
      },
      {
        id: "g_passiversatz_d10",
        prompt: "Ergänze: „Der Termin kann verschoben werden.“ → „Der Termin ist ___. (-bar)“",
        answer: "verschiebbar",
        explain: "-bar attaches to the verb stem: verschieb + bar.",
        gloss: "The appointment can be moved.",
      },
    ],
  },
  {
    ...
    drills: [
      ...
      {
        id: "g_subjektive_modalverben_d6",
        prompt: "Die Nachbarin ___ das Paket angenommen haben, sagt jedenfalls der Bote.",
        answer: "soll",
        options: ["soll", "will", "muss", "darf"],
        explain: "'sollen' reports someone else's claim, and the speaker stays neutral.",
        gloss: "The neighbour is said to have accepted the parcel.",
      },
      {
        id: "g_subjektive_modalverben_d7",
        prompt: "Er ___ nichts davon gewusst haben, behauptet er selbst.",
        answer: "will",
        options: ["will", "soll", "kann", "mag"],
        explain: "'wollen' marks the subject's own claim about themselves, with a hint of doubt.",
        gloss: "He claims to have known nothing about it.",
      },
      {
        id: "g_subjektive_modalverben_d8",
        prompt: "Ergänze: Fast sicher: „Das Licht brennt, sie ___ noch im Büro sein.“",
        answer: "muss",
        explain: "'müssen' expresses the strongest inference from evidence.",
        gloss: "The light is on, she must still be in the office.",
      },
      {
        id: "g_subjektive_modalverben_d9",
        prompt: "Ergänze: Vorsichtige Schätzung: „Die Reparatur ___ etwa 200 Euro kosten.“",
        answer: "dürfte",
        explain: "'dürfte' is a careful estimate, weaker than müssen and politer than wird.",
        gloss: "The repair is likely to cost around 200 euros.",
      },
      {
        id: "g_subjektive_modalverben_d10",
        prompt: "Ergänze: Fremde Behauptung über früher: „Das Gerät ___ schon zweimal repariert worden sein.“",
        answer: "soll",
        explain: "'sollen' plus a Perfekt infinitive reports a claim about the past.",
        gloss: "The device is said to have been repaired twice already.",
      },
    ],
  },
  {
    ...
    drills: [
      ...
      {
        id: "g_modalpartikeln_d6",
        prompt: "Überraschung ausdrücken: „Sie sind ___ schon fertig!“",
        answer: "ja",
        options: ["ja", "denn", "mal", "eben"],
        explain: "Stressed 'ja' in a statement marks genuine surprise.",
        gloss: "You are finished already!",
      },
      {
        id: "g_modalpartikeln_d7",
        prompt: "Dringlichkeit in einer Bitte: „Melden Sie sich ___ bald.“",
        answer: "doch",
        options: ["doch", "denn", "ja", "wohl"],
        explain: "'doch' pushes a request without making it an order.",
        gloss: "Do get in touch soon.",
      },
      {
        id: "g_modalpartikeln_d8",
        prompt: "Ergänze: Interesse in einer Frage: „Wie lange dauert das ___?“",
        answer: "denn",
        explain: "'denn' in a question softens it and signals real interest.",
        gloss: "How long does that take, then?",
      },
      {
        id: "g_modalpartikeln_d9",
        prompt: "Ergänze: Bekanntes Wissen: „Sie kennen ___ unsere Öffnungszeiten.“",
        answer: "ja",
        explain: "Unstressed 'ja' appeals to something both sides already know.",
        gloss: "You know our opening hours, of course.",
      },
      {
        id: "g_modalpartikeln_d10",
        prompt: "Ergänze: Unabänderlich: „Der Bescheid kommt ___ erst nächste Woche.“",
        answer: "eben",
        explain: "'eben' presents a fact as something that cannot be changed.",
        gloss: "The decision simply will not come until next week.",
      },
    ],
  },
