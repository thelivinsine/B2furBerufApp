...
> in `docs/archive/TAXONOMY_REDESIGN.md` (+ `docs/reference/TAXONOMY_REDESIGN.pptx`). The deck explains *what*
...
The approved redesign (see `docs/archive/TAXONOMY_REDESIGN.md` + `docs/reference/TAXONOMY_REDESIGN.pptx`)
