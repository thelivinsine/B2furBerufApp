...
The session-first loop that replaced the old "drawer of 11 tools" (four zones: Spielplatz ·
Bibliothek · Fortschritt + hidden Anwenden; that first zone was named Praktisch until s210).
History: `docs/DECISIONS.md`, `docs/archive/UX_OVERHAUL_PLAN.md`.
